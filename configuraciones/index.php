...
<div class="hub-module">
    ...
    <div class="hub-grid">
        ...
        <!-- Usuarios -->
        <a class="hub-card" href="/canetto/configuraciones/usuarios.php">
        ...
        <!-- Roles -->
        <a class="hub-card" href="/canetto/configuraciones/roles.php">
        ...
        <!-- Roles por usuario -->
        <a class="hub-card" href="/canetto/configuraciones/roles_usuario.php">
        ...
        <!-- Métodos de pago -->
        <a class="hub-card" href="/canetto/configuraciones/metodos_pago.php">
        ...
        <!-- Sucursales -->
        <a class="hub-card" href="/canetto/configuraciones/sucursales.php">
        ...
        <!-- Auditoría -->
        <a class="hub-card" href="/canetto/configuraciones/auditoria.php">
